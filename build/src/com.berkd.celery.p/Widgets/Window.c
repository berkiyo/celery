/* Window.c generated by valac 0.48.17, the Vala compiler
...
static GType jarvis_window_get_type_once (void);
...
static GType
jarvis_window_get_type_once (void)
{
...
jarvis_window_get_type (void)
{
	...
	if (g_once_init_enter (&jarvis_window_type_id__volatile)) {
		GType jarvis_window_type_id;
		jarvis_window_type_id = jarvis_window_get_type_once ();
